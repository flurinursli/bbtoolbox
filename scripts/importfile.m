function CELL01 = importfile(filename, flag, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   CELL01 = IMPORTFILE(FILENAME) Reads data from text file FILENAME for
%   the default selection.
%
%   CELL01 = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   CELL01 = importfile('CELL_01.BBT', 1, 60);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2017/06/06 15:52:53
